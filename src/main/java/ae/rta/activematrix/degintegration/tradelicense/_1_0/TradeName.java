...
@XmlRootElement(name = "TradeName")
public class TradeName {

    @XmlElementRef(name = "Value", namespace = "http://www.rta.ae/Activematrix/DEGIntegration/TradeLicense/1_0", type = Value.class, required = false)
    @XmlMixed
